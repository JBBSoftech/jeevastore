...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/jeevastore_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '6953b688019f7cb82c9e0878',
      shopName: 'jeevastore',
...
app.listen(PORT, () => {
  console.log(`jeevastore Backend Server running on port ${PORT}`);
});
