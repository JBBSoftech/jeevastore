...
class ApiConfig {
  ...
  static const String adminObjectId = '6953b688019f7cb82c9e0878'; // Will be replaced during publish
...
class AdminManager {
  ...
  static Future<String?> _autoDetectAdminId() async {
    try {
      final response = await http.get(
        Uri.parse('http://10.171.35.184:5000/api/admin/app-info'),
        headers: {'Content-Type': 'application/json'},
      );
  ...
  Future<void> _signIn() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('http://10.171.35.184:5000/api/login'),
        headers: {'Content-Type': 'application/json'},
        body: json.encode({
